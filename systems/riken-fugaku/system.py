            ...
            selections = {
                "packages": {
                    ...
                    "python": {
                        "externals": [
                            {
                                "spec": "python@3.11.10 arch=linux-rhel8-a64fx",
                                "prefix": "/usr",
                            }
                        ]
                    },
                    ...
                    "fujitsu-mpi": {
                        ...
                        "externals": [
                            {
                                "spec": "fujitsu-mpi@4.11.1%fj@4.11.1 arch=linux-rhel8-a64fx",
                   ...
                   # },
                    ...
                    "openmpi": {
                        ...
                        "externals": [
                            {
                                "spec": "openmpi@5.0.8",
                                "prefix": "/home/users/seydou.ba/packages/openmpi-5.0.8",
                            },
                        ],
                    },
                    "openssl": {
                ...
                selections["compilers"] += [
                    {
                        "compiler": {
                            ...
                            "modules": [],
                            "paths": {
                                "cc": "/opt/FJSVstclanga/cp-1.0.30.01/bin/fcc",
                                "cxx": "/opt/FJSVstclanga/cp-1.0.30.01/bin/FCC",
                                "f77": "/opt/FJSVstclanga/cp-1.0.30.01/bin/frt",
                                "fc": "/opt/FJSVstclanga/cp-1.0.30.01/bin/frt",
                            },
                            "flags": {},
                            "operating_system": "rhel8",
                            "target": "aarch64",
